...
if __name__ == "__main__":
    ...
    while i <= scale:
        ...
        for j in range(iterations):
            ...
            ql_09_profit, ql_accept_09, ql_federate_09 = mdp_policy_result(demands, ql_09_policy, ql_09_profit, ql_accept_09, ql_federate_09)
            
            ql_05_profit, ql_accept_05, ql_federate_05 = mdp_policy_result(demands, ql_05_policy, ql_05_profit, ql_accept_05, ql_federate_05)
