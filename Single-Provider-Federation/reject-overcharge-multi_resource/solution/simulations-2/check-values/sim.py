...
if __name__ == "__main__":
    ...
    while i <= scale:
        ...
        for j in range(iterations):
            ...
            ql_95_policy = QL.qLearning(env, episode_num, 1, best_QL_alpha, best_QL_epsilon, QL_gamma_95, prefix="QL-95")
            #print("---------- QL-0.95 --------------")
            #DP.print_policy(ql_95_policy)
        
            ql_55_policy = QL.qLearning(env, episode_num, 1, best_QL_alpha, best_QL_epsilon, QL_gamma_55, prefix="QL-55")
            #print("---------- QL-0.55 --------------")
            #DP.print_policy(ql_55_policy)
        
            ql_20_policy = QL.qLearning(env, episode_num, 1, best_QL_alpha, best_QL_epsilon, QL_gamma_20, prefix="QL-20")
            #print("---------- QL-0.55 --------------")
            #DP.print_policy(ql_20_policy)
        
            rl_policy = RL.rLearning(env, episode_num, 1, best_RL_alpha, best_RL_epsilon, best_RL_beta, prefix="RL")
            #print("---------- RL --------------")
