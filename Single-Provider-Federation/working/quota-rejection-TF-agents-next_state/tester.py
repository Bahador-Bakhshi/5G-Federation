...
import DP
import TF_Agent
import TF_Agent_next
from Environment import State, debug, error, warning, verbose, traffic_loads
...
if __name__ == "__main__":
    ...
    while i <= scale:
        ...
        for j in range(iterations):
            ...
            greedy_profit_00 = greedy_profit_50 = greedy_profit_100 = dp_profit_05 = dp_profit_30 = dp_profit_60 = dp_profit_95 = ql_profit = ql_next_profit = 0
            greedy_accept_00 = greedy_accept_50 = greedy_accept_100 = dp_accept_05 = dp_accept_30 = dp_accept_60 = dp_accept_95 = ql_accept = ql_next_accept = 0
            greedy_federate_00 = greedy_federate_50 = greedy_federate_100 = dp_federate_05 = dp_federate_30 = dp_federate_60 = dp_federate_95 = ql_federate = ql_next_federate = 0
            ...
            agent_next = TF_Agent_next.main()
            ql_next_profit, ql_next_accept, ql_next_federate = TF_Agent_next.evaluate_agent(agent_next, demands)
