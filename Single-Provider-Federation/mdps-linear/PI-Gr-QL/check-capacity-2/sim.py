...
if __name__ == "__main__":
    ...
    while i <= scale:
        OldEnvironment.Environment.domain.total_cpu = init_size + i * step
        ...
        for j in range(iterations):
            ...
            OldEnvironment.Environment.print_reqs(demands)
        ...
        print("Capacity_Profit = ", OldEnvironment.Environment.domain.total_cpu)
        ...
        print("Capacity_Accept = ", OldEnvironment.Environment.domain.total_cpu)
        ...
        print("Capacity_Federate = ", OldEnvironment.Environment.domain.total_cpu)
