...
if __name__ == "__main__":
    ...
    while i <= scale:
        ...
        for j in range(iterations):
            ...
            ql_55_policy = QL.qLearning(env, episode_num, 1, best_QL_alpha, best_QL_epsilon, QL_gamma_55)
            print("---------- QL-0.55 --------------")
        ...
        print("Overcharge_Profit = ", episode_num)
        ...
        print("Overcharge_Accept = ", episode_num)
        ...
        print("Overcharge_Federate = ", episode_num)
        ...
        print("Overcharge_Reject = ", episode_num)
