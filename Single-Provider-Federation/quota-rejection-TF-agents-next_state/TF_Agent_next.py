...
def create_env():
    ...
    train_py_env = TF_Environment_next.TF_Agent_Env_Wrapper(sim_num =  sim_num)
    #utils.validate_py_environment(train_py_env, episodes = env_validation_episodes)
    eval_py_env = TF_Environment_next.TF_Agent_Env_Wrapper(sim_num = sim_num)
...
def evaluate_agent(agent, demands):
    print("\n\n\n\n\n\n")
    print("------------- Evaluating -------------")
    test_py_env = TF_Environment_next.TF_Agent_Env_Wrapper(sim_num = sim_num, requests = demands)
