...
if __name__ == '__main__':
    ...
    while i <= max_eps:
        ...
        for j in range(10):
            ...
            greedy_profit_fed, greedy_profit_no_fed, ql_profit = simulator(episodes = i, alpha = 0.35, discount = 0.75, configFile = "domain_config.json", inCSV = "test_data.csv")
    ...
    x = np.arange(step, max_eps + 1, step)
    print(x)
