...
def q_learning(env, big_cpus_test, big_disks_test, big_mems_test, big_time_test,
    ...
    Q = np.zeros(shape=(tot_states, tot_actions), dtype=np.float)
...
if __name__ == '__main__':
    ...
    simulator(episodes = 10, alpha = 0.55, discount = 0.3, configFile = args.configFile, inCSV = args.inCSV)
